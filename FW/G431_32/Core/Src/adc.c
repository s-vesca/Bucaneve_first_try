...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  PA3   ------> ADC1_IN4
  */
  GPIO_InitStruct.Pin = COS_P_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(COS_P_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = COS_N_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(COS_N_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = VDC_SENSE_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(VDC_SENSE_GPIO_Port, &GPIO_InitStruct);
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC1, LL_ADC_CHANNEL_4, LL_ADC_SAMPLINGTIME_640CYCLES_5);
  LL_ADC_SetChannelSingleDiff(ADC1, LL_ADC_CHANNEL_4, LL_ADC_SINGLE_ENDED);
  LL_ADC_SetOffset(ADC1, LL_ADC_OFFSET_1, LL_ADC_CHANNEL_4, 0);
  ...
  */
  ...
  LL_ADC_SetOffset(ADC1, LL_ADC_OFFSET_1, LL_ADC_CHANNEL_1, 2048);
  LL_ADC_SetOffsetSign(ADC1, LL_ADC_OFFSET_1, LL_ADC_OFFSET_SIGN_NEGATIVE);
  LL_ADC_SetOffsetSaturation(ADC1, LL_ADC_OFFSET_1, LL_ADC_OFFSET_SATURATION_DISABLE);
...
void MX_ADC2_Init(void)
{
  ...
  */
  ...
  PA7   ------> ADC2_IN4
  */
  GPIO_InitStruct.Pin = SIN_P_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SIN_P_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = SIN_N_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SIN_N_GPIO_Port, &GPIO_InitStruct);
  ...
  */
  ...
  LL_ADC_SetOffset(ADC2, LL_ADC_OFFSET_1, LL_ADC_CHANNEL_3, 2048);
